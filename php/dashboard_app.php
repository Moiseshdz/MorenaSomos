...
<head>
    ...
    <link rel="stylesheet" href="../style/dashboard.css?v=16" />
...
<body>
    ...
    <div class="dashboard-container" id="dashboardContainer" style="display: none">
        ...
        <div class="card-welcome">
            ...
            <h3 id="userNombre"></h3>
           <p id="subtitle"> <i class="fa fa-link"> </i> </p>

            <h1 style="font-size: 20px;" id="userCURP"></h1>
        ...
        <div class="seccion" id="seccion-home">
            ...
            <div id="anuncios" style="margin-top:20px; text-align:center; margin-bottom:60px;">
                <div
                    style="background:#f4f4f4; border:1px solid #ccc; padding:15px; border-radius:8px; margin-bottom:10px;">
                    <h3 style="color:#611232; margin:0;">📢 Anuncio Importante</h3>
                    <p style="margin:5px 0 0;">Aquí aparecerán mensajes y avisos para los usuarios.</p>
                </div>

                <div
                    style="background:#f4f4f4; border:1px solid #ccc; padding:15px; border-radius:8px; margin-bottom:10px;">
                    <h3 style="color:#611232; margin:0;">✅ Recordatorio</h3>
                    <p style="margin:5px 0 0;">No olvides registrar nuevos afiliados desde el menú de Registro.</p>
                </div>
            </div>
        ...
        <div class="seccion" id="seccion-notificaciones">
            ...
            <p style="text-align:center;">Aquí aparecerán tus notificaciones y alertas importantes.</p>
        </div>
    ...
    <script src="../js/lista.js?v=2"></script>
